...
console.log("CONNECTING DARKWOLF_MD BOT 🧬...");
...
console.log('DARKWOLF_MD CONNECTED TO WHATSAPP ENJOY ✅')
...
*•────────────•⟢*
`;
conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://raw.githubusercontent.com/hiran-md/Darkwolf-DATA_BASE/refs/heads/main/Logo/file-UtUL3R7BtcVRTn2Z2N21rv%20(1).webp?token=GHSAT0AAAAAAC5GPW4JAGIXIEHJ6LMKGAT2Z4PRO5Q` }, caption: up })
...
app.get("/", (req, res) => {
res.send("HEY, DARKWOLF MD STARTED ✅");
});
